...
local utils = require('lib.kutils')
local diag_qfid
local sign_icons
...
function M.initialize()
    ...
    keymap('n', '<Leader>sf', [[<Cmd>CocCommand clangd.switchSourceHeader<CR>]])

    keymap('n', '<Leader>st', [[<Cmd>CocCommand go.test.toggle<CR>]])
    keymap('n', '<Leader>tf', [[<Cmd>CocCommand go.test.generate.function<CR>]])
    keymap('x', '<Leader>tf', [[:CocCommand go.test.generate.function<CR>]])
end
